...
public class HibernateEntityMapper implements EntityMapper {
    ...
    class HibernateEntity implements Entity {
        ...
        public HibernateEntity(String dataSourceName, Object id) {
            ...
            MetamodelImplementor model = (MetamodelImplementor) sessionFactory.getMetamodel();
            metadata = (ClassMetadata) model.entityPersisters().get(dataSourceName);
            if (id != null) {
        ...
        public HibernateEntity(Object object) {
            ...
            MetamodelImplementor model = (MetamodelImplementor) sessionFactory.getMetamodel();
            metadata = (ClassMetadata) model.entityPersisters().get(object.getClass().getName());
        }
